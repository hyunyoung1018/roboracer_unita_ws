#!/usr/bin/env python3
"""One tkinter prompt, for the tuner's menu items that need a number.

Lifted unchanged from UNICORN's gb_optimizer/pop_up_display.py. tkinter is
otherwise unused in this workspace, so it is declared on raceline's package.xml
as python3-tk - and the tuner is the only thing that pulls it in.
"""
